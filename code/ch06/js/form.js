(function(){
	...
	let elForm, elSelectPackage, elPackageHint, elTerms, elTermsHint; // Объявляем переменные
	...
	function packageHint() {                                 // Объявляем функцию
	  const pack = this.options[this.selectedIndex].value;     // Получаем выбранный вариант
