(function(){
	...
	function charCount(e) {                                    // Объявляем функцию
	  let textEntered, charDisplay, counter, lastkey;          // Объявляем переменные
	...
	const el = document.getElementById('message');                   // Получаем элемент, в котором находится сообщение
